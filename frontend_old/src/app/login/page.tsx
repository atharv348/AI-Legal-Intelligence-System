...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 font-sans py-12 relative">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center p-0 bg-white rounded-2xl shadow-xl shadow-black/20 mb-4 overflow-hidden w-20 h-20 border-2 border-white">
            <Image
              src="/logo.jpg"
              alt="ALIS Logo"
              width={80}
          ...
          <h1 className="text-4xl font-black text-white tracking-tighter drop-shadow-md flex items-center justify-center gap-3">
            <Gavel className="text-blue-400" size={32} />
            ALIS
          </h1>
          <p className="text-slate-100 mt-2 font-semibold drop-shadow-sm">
            AI Legal Intelligence System
          </p>
        </div>

        {/* Auth Card */}
        <div className="bg-white dark:bg-[#1E293B] rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-blue-500/10 border border-slate-100 dark:border-slate-800 p-8">
          <div className="mb-6">
